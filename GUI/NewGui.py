...
frame3 = CTkFrame(master=GUI,width=250,height=200)
...
frame4 = CTkFrame(master=GUI,width=250,height=200)
...
frame5 = CTkFrame(master=GUI,width=250,height=200,bg_color="#81B0E0")
