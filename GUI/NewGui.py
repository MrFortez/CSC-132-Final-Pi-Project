...
frame4_label = CTkLabel(master=frame4,text="Thickness",font=("Arial", 20),text_color="Black")
frame4_label.grid(column=0,row=0,sticky=N)
frame4_label = CTkLabel(master=frame4,text="How thick are the cuts?",font=("Arial", 20),text_color="Black")
